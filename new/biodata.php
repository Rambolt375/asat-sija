...
<head>
  ...
  <!-- plugins:css -->
  <link rel="stylesheet"  href="assets/Form/vendors/mdi/css/materialdesignicons.min.css">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="assets/Form/pages/forms/basic_elements.html">
              <span class="menu-title">Biodata</span>
              <i class="mdi mdi-contacts menu-icon"></i>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="assets/Form/pages/forms/kontak.html">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="date" class="form-control" placeholder="assets/Form/yyyy"/ name="tgl_lahir" id="tgl_lahir">
                        </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group">  
                            ...
                            <div class="input-group col-xs-12">
                              <input type="text" class="form-control file-upload-info" placeholder="Upload Image" name="url_hero" id="url_hero">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="form-group">  
                            <input type="file" name="img[]" class="file-upload-default">
                            <div class="input-group col-xs-12">
                              <input type="text" class="form-control file-upload-info" placeholder="Upload Image" name="url_foto" id="url_foto">
                              <span class="input-group-append">
                                <button class="file-upload-browse btn btn-gradient-primary" type="button">Upload</button>
                              </span>
                            </div>
                      ...
                      <span class="input-group-append">
                                <button class="file-upload-browse btn btn-gradient-primary" type="button">Cancel</button>
                              </span>
                      <span class="input-group-append">
