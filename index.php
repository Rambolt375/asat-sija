...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center light-background sticky-top">
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="biodata.php" class="logo d-flex align-items-center me-auto me-xl-0">
        <!-- Uncomment the line below if you also wish to use an image logo -->
        <!-- <img src="assets/kelly/img/logo.png" alt=""> -->

        <h1 class="sitename"><?php
        // Fetch data from the database
        $query = "SELECT * FROM biodata ORDER BY id DESC LIMIT 1";
        $result = mysqli_query($koneksi, $query);
        $data = mysqli_fetch_assoc($result);
         echo isset($data['nama_depan']) ? htmlspecialchars($data['nama_depan']) : ''; ?> <?php
        ?>
        </h1>
      </a>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section">
      ...
      <img src="<?php echo $data['url_hero'];?>" alt="bg" data-aos="fade-in">

      <div class="container text-center" data-aos="zoom-out" data-aos-delay="100">
        <div class="row justify-content-center">
          <div class="col-lg-8">
            <h2><?php echo isset($data['nama_depan']) ? htmlspecialchars($data['nama_depan']) : ''; ?>  <?php echo isset($data['nama_belakang']) ? htmlspecialchars($data['nama_belakang']) : ''; ?></h2>
            <p>I'm a <?php echo isset($data['profesi']) ? htmlspecialchars($data['profesi']) : ''; ?> from <?php echo isset($data['kota']) ? htmlspecialchars($data['kota']) : ''; ?></p>
  ...
  <script src="assets/kelly/vendor/php-email-form/validate.js"></script>
